...
const youtube = {
  ...
  toBlock: function(obj) {
    return `<div class="video-container"><iframe src="https://www.youtube.com/embed/${obj.id}" class="video" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>`
  },
...
const vimeo = {
  ...
  label: "Vimeo",
  // Fields the user need to fill out when adding an instance of the component
  fields: [{ name: "url", label: "Any vimeo URL", widget: "string" }],
  // Pattern to identify a block as being an instance of this component
  pattern: /^`oembed: ([^`]*)`$/,
  // Function to extract data elements from the regexp match
  fromBlock: function(match) {
  ...
  toPreview: function({ url }) {
    return `Vimeo video with url: ${url} will go here (sorry didn't know how to make a preview)`
  },
}
...
const whitespace = {
  ...
  toBlock: function(obj) {
    ...
    return `<div class="${obj.className ? obj.className : ""}"></div>`
  },
  // Preview output for this component. Can either be a string or a React component
  // (component gives better render performance)
  toPreview: function(obj) {
...
CMS.registerEditorComponent(vimeo)
